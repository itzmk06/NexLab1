...
const Login=()=>{
    return(
        <div className="md:bg-white bg-[#DAF0EE] w-full  h-screen flex justify-center items-center rounded-lg ">
            <div className="md:w-5/12 justify-center items-center bg-[#DAF0EE] h-[90%] flex flex-col gap-5  rounded-3xl p-2">
                <div>
