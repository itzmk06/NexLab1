        ...
        <div className="mt-1  w-full md:h-14 h-12 px-1 py-2    md:px-3 md:py-2 z-[999] relative">
            <div className="flex justify-between items-center text-base font-medium">
                ...
                <div className="flex md:gap-x-3 gap-x-3">
                   <Link to={'/login'} className="cursor-pointer bg-white px-3 py-1 text-black rounded-md font-semibold">
                  Login
                   </Link>
                    <button className="bg-black bg-opacity-90 px-3 py-1 text-zinc-200 rounded-md font-semibold">Sign up</button>
                </div>
            </div>
        </div>
    )
