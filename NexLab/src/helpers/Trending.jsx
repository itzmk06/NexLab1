...
const Trending=()=>{
    return(
        <div className="w-[98%] px-2 transform   flex justify-center mb-1 md:w-full ml-1 md:ml-0 md:mt-[-0.4rem] md:p-2 md:pr-3  overflow-y-auto h-50">
            <div className="bg-[#F4F4F4] w-full h-full px-2 py-1 rounded-xl bg-opacity-10 text-zinc-100">
            <div className="flex gap-1 items-center justify-start">
                    <h1 className="text-base font-medium">NexSpotlight</h1>
                ...
                <div className="flex flex-row items-center justify-start mt-2">
                    <button className=" px-2 py-1 mb-1 text-sm md:font-semibold bg-[#00BFFF] rounded-md text-black  shadow-lg transition-transform duration-300 ease-in-out hover:bg-[#1b98c2a8] transform hover:scale-105">Discover more</button>
                </div>
            </div>
        </div>
    )
