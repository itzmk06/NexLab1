        ...
        <div className="bg-[#202020] w-full md:w-full h-24 group rounded-lg shadow-lg p-3 flex justify-between items-center transition transform hover:scale-105 hover:bg-[#292929] duration-300 ease-in-out cursor-pointer">
            <div className="flex items-center gap-3 ">
                ...
                <div className="flex flex-col gap-0.5">
                    ...
                    <p className="text-[#B0B0B0] text-xs truncate max-w-[180px] group-hover:text-white">
            ...
            <div className="flex items-end top-0 right-0 absolute mt-1 ">
                <div className="flex items-center gap-1 bg-gradient-to-r  px-2 py-0.5 rounded-full text-xs text-[#292929] shadow-md transform hover:scale-110 transition duration-150 ease-in-out">
                    <img 
                        className="w-4 h-4 " 
                        src="https://cdn-icons-png.flaticon.com/128/7656/7656139.png" 
                        alt="Star Icon"
                    />
                    <span className="font-semibold text-[#FFC107] text-sm">4.5</span>
                </div>

                <div className="flex items-center gap-1 bg-gradient-to-r  px-2 py-0.5 rounded-full text-xs text-white shadow-md transform hover:scale-110 transition duration-150 ease-in-out">
                    <img 
                        className="w-4 h-4" 
